    ...
    <div class="w-full max-w-md p-8">
        <div class="bg-white rounded-4xl p-10 shadow-2xl border border-neutral/5">
            <div class="text-center mb-10">
                <a href="index.php" class="text-2xl font-black text-neutral tracking-tighter uppercase italic block mb-6">Kohi <span class="text-primary">Sekai</span></a>
            ...
            <form action="login.php" method="POST" class="space-y-6" x-data="{ 
                showPass: false,
                isLoading: false,
