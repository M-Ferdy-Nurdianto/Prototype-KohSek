    ...
    <div class="container mx-auto px-6 grid md:grid-cols-2 gap-12 items-center relative z-10">
        <div class="space-y-8">
            ...
            <div class="flex flex-wrap gap-4">
                <a href="cheki.php" class="bg-primary text-white px-10 py-4 rounded-full font-bold text-lg hover:scale-105 transition-transform shadow-xl shadow-primary/30">Buy Cheki Ticket</a>
        ...
        <div class="relative group">
            ...
            <img src="assets/img/hero.png" alt="Kohi Sekai Group" class="relative rounded-4xl shadow-2xl w-full object-cover aspect-[4/5] md:aspect-square">
        </div>
    </div>
                ...
                <div class="group bg-background rounded-3xl p-8 border border-neutral/5 hover:border-primary/20 transition-all duration-500 hover:shadow-2xl hover:shadow-primary/5">
                    <div class="flex justify-between items-start mb-6">
                        <div class="bg-white px-4 py-2 rounded-2xl shadow-sm text-center">
                            <span class="block text-primary font-bold text-xl"><?php echo explode(' ', $event['date'])[0]; ?></span>
                            <span class="block text-neutral/50 text-[10px] uppercase font-bold"><?php echo explode(' ', $event['date'])[1]; ?></span>
                        </div>
                        <div class="px-4 py-1.5 rounded-full bg-secondary/40 text-primary text-xs font-bold"><?php echo $event['time']; ?></div>
                    </div>
                    <h3 class="text-2xl font-bold text-neutral mb-2 group-hover:text-primary transition-colors"><?php echo $event['title']; ?></h3>
                    <div class="flex items-center text-neutral/60 mb-6">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
                        </svg>
                        <span class="text-sm"><?php echo $event['location']; ?></span>
                    </div>
                    <div class="flex justify-between items-center">
                        <span class="text-lg font-extrabold text-neutral"><?php echo $event['price']; ?></span>
                        <a href="cheki.php" class="text-primary font-bold hover:underline">Get Tickets &rarr;</a>
                    </div>
                </div>
            <?php endforeach; ?>
        </div>
